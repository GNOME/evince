...
/* Thanks, gtk+, for now exporting this essential API! */
                             ...
                             gpointer                   user_data)
{
        ...
        if (GDK_IS_WAYLAND_DISPLAY (gtk_widget_get_display (GTK_WIDGET (window)))) {
                gboolean (* _gdk_wayland_window_export_handle)(GdkWindow*,
                                                               EvGdkWaylandWindowExported,
                                                               gpointer,
                                                               GDestroyNotify);
                ...
                _gdk_wayland_window_export_handle = dlsym(RTLD_DEFAULT, "gdk_wayland_window_export_handle");

                if (_gdk_wayland_window_export_handle == NULL ||
                    !_gdk_wayland_window_export_handle (gdk_window,
