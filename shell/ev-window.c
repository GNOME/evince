...
static void
file_open_dialog_response_cb (GtkFileChooserNative *chooser,
			      gint       response_id,
			      EvWindow  *ev_window)
{
...
static void
file_save_dialog_response_cb (GtkFileChooserNative *fc,
			      gint       response_id,
			      EvWindow  *ev_window)
{
	EvWindowPrivate *priv = GET_PRIVATE (ev_window);
...
static void
attachment_save_dialog_response_cb (GtkFileChooser *fc,
				    gint       response_id,
				    EvWindow  *ev_window)
{
	EvWindowPrivate *priv = GET_PRIVATE (ev_window);
