                                        ...
                                        gpointer       user_data)
{
    ...
    ev_view_begin_add_annotation (EV_VIEW (ev_window->priv->view), EV_ANNOTATION_TYPE_TEXT_MARKUP);
}
...
static const GActionEntry actions[] = {
	...
	{ "hightlight-annotation", NULL, NULL, "false", ev_window_cmd_add_highlight_annotation },
